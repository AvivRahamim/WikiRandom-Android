...
public class GameActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        // create outlet/reference to each answer button in the answerButtons array
    ...
    public void checkAnswer(View view)
    {
        ...
        if (view.getTag().equals(randArt_ID))
        {
            ...
            // animate the "correct +1!" bar , as soon as he appearing when the user's answer is correct
    ...
    {
        // animate the mute/unMute button
