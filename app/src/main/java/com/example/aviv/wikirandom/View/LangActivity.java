...
public class LangActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        // dont let not authenticated users to get to language selection screen. if they are here, return them to login
        ...
        //give each button in the array of button, an outlet\a reference
