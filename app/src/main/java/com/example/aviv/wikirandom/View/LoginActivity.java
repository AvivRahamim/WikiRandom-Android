...
public class LoginActivity extends Activity
{
            ...
            mAuth.signInWithEmailAndPassword(email, password)
                    .addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>()
                    {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task)
                        {
                            ...
                            {
                                Log.d("task", "task was not successful!");
                                Toast.makeText(LoginActivity.this,"User does not exist! Please enter vaild information!",Toast.LENGTH_LONG).show();
                            }
                        }
                    });
        }
    ...
    {
        //Do Animation to register button
        YoYo.with(Techniques.Flash)
                .duration(300)
                .playOn(findViewById(view.getId()));
